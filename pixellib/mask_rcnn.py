...
class MaskRCNN(object):
    ...
    def train(self, train_dataset, val_dataset, epochs,layers,models,
        ...
        callb = [
            ...
            tf.keras.callbacks.TensorBoard(log_dir=logdir, histogram_freq=0, write_graph=False, write_images=False, update_freq='epoch', profile_batch=2, embeddings_freq=0, embeddings_metadata=None),
            lr_rate,
        ]
